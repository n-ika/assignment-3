...
If I chose the means for H2 according to the difference of the observed means difference, the two disctributions superpose even more (`plot_H1_H2_3obs`). It is now much less evident if the language has any influence on the rating.